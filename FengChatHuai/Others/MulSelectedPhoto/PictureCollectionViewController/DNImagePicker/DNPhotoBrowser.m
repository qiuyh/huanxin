    ...
    if (self.checkButton.selected) {
        ...
        [UIView animateKeyframesWithDuration:0.5 delay:0 options:0 animations: ^{
            [UIView addKeyframeWithRelativeStartTime:0 relativeDuration:1 / 3.0 animations: ^{
                ...
                self.checkButton.transform = CGAffineTransformMakeScale(1.5, 1.5);
            }];
            [UIView addKeyframeWithRelativeStartTime:1/3.0 relativeDuration:1/3.0 animations: ^{
                
                self.checkButton.transform = CGAffineTransformMakeScale(0.8, 0.8);
            }];
            [UIView addKeyframeWithRelativeStartTime:2/3.0 relativeDuration:1/3.0 animations: ^{
                
                self.checkButton.transform = CGAffineTransformMakeScale(1.0, 1.0);
            }];
        } completion:nil];
        

//        [UIView animateWithDuration:0.2 animations:^{
//            self.checkButton.transform = CGAffineTransformMakeScale(1.2, 1.2);
//        }
