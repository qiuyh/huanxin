...
- (NSString *)makeToken:(NSString *)accessKey secretKey:(NSString *)secretKey signingStr:(NSString *)signingStr{
    
    NSString *signingStr1 = [NSString stringWithFormat:@"%@\n",signingStr];
    
    const char *secretKeyStr = [secretKey UTF8String];
    
    NSData *policyData = [signingStr1 dataUsingEncoding:NSUTF8StringEncoding];
    ...
    NSString *token = [NSString stringWithFormat:@"%@:%@",  accessKey, encodedDigest];
